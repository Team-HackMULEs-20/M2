...
public class AntLabMain {
	...
	public void printOutMessage() {
		...
		Person1 p1 = new Person1("Kaley");
		toPrint += p1.toString("kfindley7");
		//Person2 replace P2 with your name
		//and gburdell with your gt id
		Person2 p2 = new Person2("Abigail Collins");
		toPrint += p2.toString("acollins41");
		//Person3 replace P3 with your name
		//and gburdell3 with your gt id
		Person3 p3 = new Person3("Carlos Gonzalez");
		toPrint += p3.toString("cgonzalez39");
		//Person4 replace P4 with your name
		//and gburdell4 with your gt id
		Person4 p4 = new Person4("Jessica Hoffman");
		toPrint += p4.toString("jhoffman40");
		//Person5 replace P4 with your name
		//and gburdell5 with your gt id
		Person5 p5 = new Person5("Christopher Ford");
		toPrint += p5.toString("cford33");
